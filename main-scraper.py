...
class Laptop:
    def __init__(self, model, curr_price, processor, os, graphics, memory, storage, display):
        self.__model = model
    ...
    def get_Data(self):
        return [self.__model, self.__curr_price, self.__processor, self.__os, self.__graphics, self.__memory, self.__storage]
